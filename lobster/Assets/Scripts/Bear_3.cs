...
public class Bear_3 : MonoBehaviour
{
    ...
    public IEnumerator Move_3()
    {
        ...
        //Invoke("EnableCol", 2); // 2초뒤에 EnableCol 이라는 함수를 호출함 
        {
            ...
            {
                transform.Translate(GameManager.instance.Bear_3_speed * Time.deltaTime * Bear_time * speed_up, 0, 0);
                yield return new WaitForEndOfFrame();
            }
    ...
    public IEnumerator Move_4()
    {
        ...
        {
            transform.Translate(0, speed_up *GameManager.instance.Bear_3_speed * Time.deltaTime * Bear_time, 0);
            yield return new WaitForEndOfFrame();
        }
