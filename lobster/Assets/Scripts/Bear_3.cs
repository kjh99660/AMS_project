...
public class Bear_3 : MonoBehaviour
{
    ...
    public IEnumerator Move()//움직이는 경로
    {
        ...
        {
            transform.Translate(GameManager.instance.Bear_3_speed * Time.deltaTime, 0, 0);
            yield return new WaitForEndOfFrame();
        }
        while (transform.position.y <= 16.9f)
        {
            transform.Translate(0, GameManager.instance.Bear_3_speed * Time.deltaTime, 0);
            yield return new WaitForEndOfFrame();
        }
    ...
    public IEnumerator Move_3()
    {
        ...
        //Invoke("EnableCol", 2); // 2초뒤에 EnableCol 이라는 함수를 호출함 
        {
            ...
            {
                transform.Translate(GameManager.instance.Bear_3_speed * Time.deltaTime * 1.3f, 0, 0);
                yield return new WaitForEndOfFrame();
            }
    ...
    public IEnumerator Move_4()
    {
        ...
        {
            transform.Translate(0, GameManager.instance.Bear_3_speed * Time.deltaTime * 1.3f, 0);
            yield return new WaitForEndOfFrame();
        }
    ...
    void Update()
    {
        if (GameManager.instance.Heal_term <= 0 && this.Bear3_hp < 10)
        {
            Bear3_hp++;
        }
    }
